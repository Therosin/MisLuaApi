...
---* Global Callback
---| EI: At this point all of the level and systems are loaded and callbacks could be registered without being overwritten,
---| however also means stuff has been instanced already and instances potentially arent effected by indirect changes.
